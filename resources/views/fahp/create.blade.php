...
@section('main')
    {{-- <div class="mb-12">
        <h3 class="mb-4 text-2xl">Fuzzy linguistic variables for the criteria</h3>
    ...
    <div class="mb-12" x-data="{
        ...
        <h3 class="mb-4 text-xl">Selection scale of criteria for prioritization environmental</h3>
        ...
        <form action="{{ route('food-type-for-production.calculation.fahp.store') }}" method="POST" class="">
            ...
            <x-theme.button-submit :route="route('food-type-for-production.calculation')" class="p-4 text-white bg-green-700 hover:bg-green-800 disabled:bg-gray-300 disabled:cursor-not-allowed" x-bind:disabled="!checkAllSelected">
