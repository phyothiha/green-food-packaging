...
class FTOPSISCalculationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return view('ftopsis.result', [
            ...
            'pure_step_5' => $this->ftopsis_service->pure_step_5(),
            ...
            'pure_step_8' => $this->ftopsis_service->pure_step_8($selected_package_material_index),
            'pure_ftopsis_tbl_ranking' =>  $this->ftopsis_service->pure_ranking($material, $input),
            'pure_x_bar' => $this->ftopsis_service->pure_x_bar(),
            'pure_mse' => $this->ftopsis_service->pure_mse(),
            'pure_rmse' => $this->ftopsis_service->pure_rmse(),
            'pure_mae' => $this->ftopsis_service->pure_mae(),
        ]);
    }
}
